...
class mcLSTM:
    ...
    def train(self):
        ...
        for day in range(test_y.shape[0]):
            mc_drop_list[day] = np.loadtxt(f'mcdrop_prediction_NASDAQ/mc_drop_list_{day}.csv', delimiter=',')
        ...
        evaluate_portfolio(test_y, test_y, top_n_list_index_test_days, day_weight, fname=args.f)
